/*ommit e pick
ommit
tip generico que ajuda a criar novos tipos apartir de tips existente excluind algumas infrmações
*/
...
interface GithubRepoResponse {
  ...
  full_name: string
  private: boolean
  /*usar ommit para trocar o obje
  voce pega o parametr que esta herdand
  e todos os tipos que voce escrever estara omitindo-os
  */
...
//repository.owner.name = `siqueira`
//name nao existe mais, pois tiramos com ommiit

type localGithubUser = Pick<GithubUserResponse, 'login' | 'id' | 'name'>
